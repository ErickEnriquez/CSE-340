...
void Parser::parse_proc_decl() {
	...
	procTable[numOfProc].code = new linkedList();//allocate the linked list on the porc table
...
Token Parser::parse_procedure_name() {//parses a procedure name and returns a token containing the procedure name
